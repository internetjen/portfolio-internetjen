...
const navigation = {
    social: [
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/internetjen/',
      ...
      {
        name: 'Twitter',
        href: 'https://twitter.com/itsjenlissette',
        icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      {
        name: 'GitHub',
        href: 'https://github.com/internetjen/',
        icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
      ...
      {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/in/jennifer-arboleda/',
        icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
